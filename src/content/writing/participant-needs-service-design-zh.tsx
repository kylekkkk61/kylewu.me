  ...
  return (
    <div className="space-y-14 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h3]:text-lg [&_h3]:font-semibold [&_p]:text-lg [&_p]:leading-8 [&_p]:text-muted-foreground">
      ...
      <section className="space-y-5" aria-labelledby="needs-before-answers-zh">
        ...
        <p>
          因此，我們把參與者直接提出的需求視為其中一項輸入，而不是完整規格。我重新看過前一屆的報名資料與活動後回饋，接收前任總召整理的完整交接，也查閱更早幾屆留在共用雲端硬碟裡的檔案。針對當屆參與者，我們分析報名表中的興趣與期待，也整理團隊成員從家教學生、學弟妹與校園人脈取得的非正式觀察。
        </p>
        <p>
      ...
      <section className="space-y-5" aria-labelledby="stable-and-adjustable-zh">
        ...
        <p>
          我們同時保留晚會、舞會與社交活動。五天全部排成課程，看起來或許更有學術深度，卻不符合高中生維持注意力、建立信任與形成回憶的方式。學習與玩樂不是互相排擠的目標，而是共同構成整段服務體驗。
        </p>
      </section>

      <section className="space-y-5" aria-labelledby="live-company-case-zh">
        <h2 id="live-company-case-zh">用一個真實問題，串起五天的學習體驗</h2>
        <p>
      ...
      <section className="space-y-6" aria-labelledby="evidence-and-limits-zh">
        <div className="space-y-5">
          ...
          <p>
            ...
            83.3%。這些資料能說明這一梯次參與者如何看待活動，但仍是單一梯次的自陳式回饋，不能當成控制實驗的結果。
          </p>
        </div>
        ...
        <p>
          這些結果無法證明各項設計與評分之間的因果關係，也不足以支持全台排名或長期教育成效等說法。但至少可以確認，在這一梯次中，參與者同時肯定課程安排與整體流程；開放式回饋也留下了對社交活動的明確記憶。
        </p>
      </section>
      ...
      >
        <h2 id="service-design-takeaway-zh">創造讓人做出更好判斷的條件</h2>
        <p>
          我們不可能要求參與者在活動開始以前，就精準描述一場理想的企管營。團隊真正需要做的，是整合他們說出的期待、歷屆參與者留下的證據、籌備團隊累積的經驗，以及現場營運允許的範圍。
        </p>
        <p>
          最後形成的服務，沒有替高中生決定應該讀什麼科系、成為什麼樣的人。它提供真實問題、有充分資訊可做的選擇、與他人建立關係的機會，以及足夠的反思空間，讓每個人離開時更理解自己的興趣。
        </p>
